...
* Version information
  ...
  #+RESULTS:
  : Emacs version: GNU Emacs 25.1.1 (x86_64-unknown-linux-gnu, GTK+ Version 3.18.9)
  :  of 2016-09-10
  : org version: 8.3.6
...
*** Table over multiple pages with long text wrapped to cell width
    ...
    # #+ATTR_LATEX: :environment tabularx :width \linewidth :align lX :placement [H]
...
** Text Footnotes
   ...
   Examples for \myindex{footnotes}.
