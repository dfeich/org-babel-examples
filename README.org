...
** Contents
   ...
   1. Babel examples vor various backends
      ...
      - [[./python/pythonbabel.org][python]]
      - [[./python/ipython-babel.org][Ipython]]
      - [[./shell/shell-babel.org][shell]] (bash)
      - [[./C/c-babel.org][C]]
      - [[./graphviz/graphviz-babel.org][graphviz]]
   ...
   2. Export backend Examples
      - [[./latex/latex-example.org][LaTeX]]
      - [[./beamer/beamer-example.org][LaTeX Beamer]] for presentations
      - [[./odt/odt-example.org][ODT]] for exporting to LibreOffice (and then also MS Word)
